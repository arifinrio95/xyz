...
def generate_image_with_style(description, style):
    response = openai.Image.create(
        model="dall-e-3",
        prompt=f"Create a {style} style and extremely detailed with natural lighting and cinematic in 4:3 ratio for this description: {description}. Remember create in {style} style and extremely detailed with natural lighting and cinematic in 4:3 ratio.",
        size="1024x1024",
        quality="standard",
        n=1
    )
